...
int tp_healthinfo_read(struct seq_file *s, void *tp_monitor_data)
{
	...
	if (!monitor_data->kernel_grip_support) {
		...
		if (monitor_data->p_grip_moni_data) {
			seq_printf(s, "exit_match_y_times:%llu\n",
						monitor_data->p_grip_moni_data->exit_match_y_times);
			seq_printf(s, "exit_match_x_times:%llu\n",
						monitor_data->p_grip_moni_data->exit_match_x_times);
			seq_printf(s, "finger_hold_matched_times:%llu\n",
						monitor_data->p_grip_moni_data->finger_hold_matched_times);
			seq_printf(s, "finger_hold_matched_max_times:%llu\n",
						monitor_data->p_grip_moni_data->finger_hold_matched_max_times);
			seq_printf(s, "finger_hold_differ_size_times:%llu\n",
						monitor_data->p_grip_moni_data->finger_hold_differ_size_times);
			seq_printf(s, "finger_hold_differ_max_times:%llu\n",
						monitor_data->p_grip_moni_data->finger_hold_differ_max_times);
			seq_printf(s, "research_point_landed_times:%llu\n",
						monitor_data->p_grip_moni_data->research_point_landed_times);
			seq_printf(s, "research_point_landed_times_force:%llu\n",
						monitor_data->p_grip_moni_data->research_point_landed_times_force);
			seq_printf(s, "research_point_landed_fail_times:%llu\n",
						monitor_data->p_grip_moni_data->research_point_landed_fail_times);
			seq_printf(s, "corner_exit_dis_match_times:%llu\n",
						monitor_data->p_grip_moni_data->corner_exit_dis_match_times);
			seq_printf(s, "corner_press_exit_match_times:%llu\n",
						monitor_data->p_grip_moni_data->corner_press_exit_match_times);
			seq_printf(s, "top_shape_exit_match_times:%llu\n",
						monitor_data->p_grip_moni_data->top_shape_exit_match_times);
			seq_printf(s, "edge_sliding_exit_matched_times:%llu\n",
						monitor_data->p_grip_moni_data->edge_sliding_exit_matched_times);
			seq_printf(s, "edge_sliding_beyond_distance_times:%llu\n",
						monitor_data->p_grip_moni_data->edge_sliding_beyond_distance_times);
		}
	}
...
int tp_healthinfo_clear(void *tp_monitor_data)
{
	...
	if (!monitor_data->kernel_grip_support) {
		...
		if (monitor_data->p_grip_moni_data) {
			monitor_data->p_grip_moni_data->exit_match_y_times = 0;
			monitor_data->p_grip_moni_data->exit_match_x_times = 0;
			...
			monitor_data->p_grip_moni_data->corner_exit_dis_match_times = 0;
			monitor_data->p_grip_moni_data->corner_press_exit_match_times = 0;
